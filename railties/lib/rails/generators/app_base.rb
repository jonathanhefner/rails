  ...
  module Generators
    ...
    private
      ...
      def compute_implied_options(options, option_reasons, meta_options: [])
        ...
        activation_order.reverse_each do |name|
