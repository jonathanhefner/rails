...
class RouteHelperIntegrationTest < ActionDispatch::IntegrationTest
  ...
  test "only includes one module with route helpers" do
    ...
    assert_operator CommentsController, :<, url_helpers_module
    assert_operator ResourcesController, :<, url_helpers_module
    assert_not_operator ActionController::Base, :<, url_helpers_module

    assert_operator CommentsController, :<, path_helpers_module
    assert_operator ResourcesController, :<, path_helpers_module
    assert_not_operator ActionController::Base, :<, path_helpers_module

    included_modules = CommentsController.ancestors.grep_v(Class)
