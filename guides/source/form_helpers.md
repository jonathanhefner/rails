...
Sometimes, we want to generate a set of choices from a collection of complex objects. For example, if we have a `City` model and corresponding `belongs_to :city` association:
