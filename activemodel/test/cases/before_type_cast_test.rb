...
class BeforeTypeCastTest < ActiveModel::TestCase
  ...
  setup do
    @before_type_cast = { name: 9876, salary: "54321", active: "0" }
    @after_type_cast = { name: "9876", salary: 54321, active: false }
