...
module ActiveRecord # :nodoc:
  module Normalization
    ...
    module ClassMethods
      ...
      # ==== Options
      #
      # * +:with+ - The normalization to apply. Can be specified as a proc or a
      #   symbol, or an array of such objects. If an array is specified, each
      #   normalization will be piped to the next in the specified order.
